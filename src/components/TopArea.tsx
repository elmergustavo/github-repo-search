...
// Componente TopArea
export const TopArea = ({ setRepositories, setIsLoading  }: TopAreaProps) => {
  ...
  function handleSubmit() {
    ...
    setEmpty(false);
    setIsLoading(true);
    fetchRepositories(usernameRef.current.value);
  }
  ...
  return (
    <Container>
      ...
      >
        ...
        />
        {empty && <Warn>Enter repository name</Warn>}
        {notFound && <Warn>Repository not found</Warn>}
